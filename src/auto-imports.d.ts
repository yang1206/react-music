...
declare global {
  ...
  const addPlaylistId: typeof import('./utils/storage')['addPlaylistId']
  const clearLoginState: typeof import('./utils/secretKey')['clearLoginState']
  const createRef: typeof import('react')['createRef']
  const deepCopy: typeof import('./utils/storage')['deepCopy']
  const formatDate: typeof import('./utils/format')['formatDate']
  const formatMinuteSecond: typeof import('./utils/format')['formatMinuteSecond']
  const formatMonthDay: typeof import('./utils/format')['formatMonthDay']
  const forwardRef: typeof import('react')['forwardRef']
  const generateSingerAlpha: typeof import('./utils/handledata')['generateSingerAlpha']
  const getCity: typeof import('./utils/format')['getCity']
  const getCount: typeof import('./utils/format')['getCount']
  const getCurrentSongIndex: typeof import('./utils/storage')['getCurrentSongIndex']
  const getFindIdIndex: typeof import('./utils/math')['getFindIdIndex']
  const getLoginInfo: typeof import('./utils/secretKey')['getLoginInfo']
  const getMatchReg: typeof import('./utils/format')['getMatchReg']
  const getParseLoginState: typeof import('./utils/format')['getParseLoginState']
  const getPlayUrl: typeof import('./utils/format')['getPlayUrl']
  const getPlaylistId: typeof import('./utils/storage')['getPlaylistId']
  const getQueryObject: typeof import('./utils/format')['getQueryObject']
  const getRandom: typeof import('./utils/math')['getRandom']
  const getSizeImage: typeof import('./utils/format')['getSizeImage']
  const handleRouter: typeof import('./utils/format')['handleRouter']
  const handleSongsCategory: typeof import('./utils/handledata')['handleSongsCategory']
  const initCurrentSongIndex: typeof import('./utils/storage')['initCurrentSongIndex']
  const lazy: typeof import('react')['lazy']
  const localClear: typeof import('./utils/storage')['localClear']
  const localGet: typeof import('./utils/storage')['localGet']
  const localRemove: typeof import('./utils/storage')['localRemove']
  const localSet: typeof import('./utils/storage')['localSet']
  const memo: typeof import('react')['memo']
  const parseLyric: typeof import('./utils/parseLyric')['parseLyric']
  const parseTime: typeof import('./utils/format')['parseTime']
  const removeAllSong: typeof import('./utils/storage')['removeAllSong']
  const removeSongId: typeof import('./utils/storage')['removeSongId']
  const resetPlaylistId: typeof import('./utils/storage')['resetPlaylistId']
  const scrollTo: typeof import('./utils/scroll')['scrollTo']
  const searchRoute: typeof import('./utils/format')['searchRoute']
  const setCurrentSongIndex: typeof import('./utils/storage')['setCurrentSongIndex']
  const setLoginInfo: typeof import('./utils/secretKey')['setLoginInfo']
  const singerAlphas: typeof import('./utils/handledata')['singerAlphas']
  const startTransition: typeof import('react')['startTransition']
  const useAddPlaylist: typeof import('./hooks/useAddPlaylist')['useAddPlaylist']
  ...
  const useChangeDropBoxState: typeof import('./hooks/useKeyboard')['useChangeDropBoxState']
  ...
  const useGlobalKeyboardEvent: typeof import('./hooks/useKeyboard')['useGlobalKeyboardEvent']
