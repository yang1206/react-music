...
// 榜单列表
const getTopListInfo = createAsyncThunk(
  'topList/getTopListInfoAction',
  async (id: number) => {
...
const getTopListTitleInfo = createAsyncThunk(
  'topList/getTopListTitleInfo',
...
const getTopListItem = createAsyncThunk(
  'topList/getTopListItem',
  async (id: number) => {
